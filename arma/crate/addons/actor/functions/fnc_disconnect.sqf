 ...
 *
 * Example:
 * [_player, _uid] call forge_crate_actor_fnc_disconnect;
 */

params [["_player", objNull, [objNull]], ["_uid", "", [""]]];

if (_uid isEqualTo "" && {!isNull _player}) then {_uid = getPlayerUID _player; };
...
["actor:disconnect", [toJSON _snapshot]] call EFUNC(extension,call) params ["_result", "_success"];
