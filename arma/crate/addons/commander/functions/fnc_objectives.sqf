 ...
 *
 * Description:
 * Resolves strategic objective positions from known markers, obj_ prefixed markers, or safe map
 * quadrant fallbacks.
 *
 * Arguments:
 * None
 *
 * Return Value:
 * Strategic objective positions [ARRAY]
 *
 * Example:
 * call forge_crate_commander_fnc_objectives;
 */
