 ...
 *
 * Example:
 * [_uid] call forge_crate_organization_fnc_getForPlayer;
 */
...
["actor:get", [_uid]] call EFUNC(extension,call) params ["_actorResult", "_actorSuccess"];
...
["organization:get", [_organizationId]] call EFUNC(extension,call) params ["_organizationResult", "_organizationSuccess"];
