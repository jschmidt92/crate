 ...
 *
 * Example:
 * [_uid, "default"] call forge_crate_organization_fnc_addMember;
 */
...
["organization:add_member", [_organization, _uid]] call EFUNC(extension,call) params ["_result", "_success"];
