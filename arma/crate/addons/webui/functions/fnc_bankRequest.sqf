 ...
 *
 * Description:
 * Executes an authoritative WebUI bank request on the server and returns a correlated response to
 * the requesting player.
 *
 * Arguments:
 * 0: [OBJECT] - Requesting player
 * 1: [STRING] - Browser request ID
 * 2: [STRING] - Bank event name
 * 3: [HASHMAP] - Event data
 *
 * Return Value:
 * Response dispatched [BOOL]
 *
 * Example:
 * [_player, _requestId, "bank::load", createHashMap] call forge_crate_webui_fnc_bankRequest;
 */
