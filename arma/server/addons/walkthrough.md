...
13 issues fixed in [fnc_createCommander.sqf](file:///g:/forge/arma/server/addons/commander/functions/fnc_createCommander.sqf):
- **Critical:** Config loading pipeline fixed (was silently discarding mission overrides)
- **Config format:** Converted [CfgCommander.hpp](file:///g:/forge/arma/server/addons/commander/CfgCommander.hpp) and mission config to array-of-arrays format
...
### [XEH_postInitServer.sqf](file:///g:/forge/arma/server/addons/commander/XEH_postInitServer.sqf) — Fix #1
...
### [fnc_reassignGroups.sqf](file:///g:/forge/arma/server/addons/commander/functions/fnc_reassignGroups.sqf) — Fixes #3, #4
...
### [fnc_findEnemySide.sqf](file:///g:/forge/arma/server/addons/commander/functions/fnc_findEnemySide.sqf) — Fixes #5, #6
...
### [fnc_getObjectivesFallback.sqf](file:///g:/forge/arma/server/addons/commander/functions/fnc_getObjectivesFallback.sqf) — Fixes #7, #8, #13
...
### [fnc_createCommander.sqf](file:///g:/forge/arma/server/addons/commander/functions/fnc_createCommander.sqf) — Fixes #9, #10, #11, #12, #14
